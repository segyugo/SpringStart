...
public class SingletoneServiceTest {
    ...
    @Test
    @DisplayName("스프링의 싱글톤 컨테이너")
    public void singletonServiceTest2() {
...
//memberService1 == memberService2
    ...
    @Test
    @DisplayName("@configation이 싱글톤을 보장하는 원리")
    public void appConfigTest() {
        AnnotationConfigApplicationContext ac = new AnnotationConfigApplicationContext(AppConfig.class);
        AppConfig m1 = ac.getBean(AppConfig.class);
        System.out.println("AppConfig는 " + m1);
